...
// The API (rte_eth_dev_filter_supported etc.) used in here was removed from DPDK
void fdir_get_infos(uint32_t port_id) {
	printf("fdir_get_infos: this feature is broken because the DPDK API was removed");
